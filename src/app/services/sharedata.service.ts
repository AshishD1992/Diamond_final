...
import { FundsData } from '../models/funds-data';
...
export class SharedataService {
  ...
  private _userDescriptionSub = new BehaviorSubject<any>(null);
  userDescription$ = this._userDescriptionSub.asObservable();

  private _userDataSub = new BehaviorSubject<any>(null);
  ...
  private _currentMatchSub = new BehaviorSubject<any>(null);
